...
# if specified, use a different name for the cantera results file. 
if len(sys.argv) == 3:
    output_file_name = sys.argv[2]
else: 
    output_file_name = "ct_analysis.csv"
...
settings_yaml = '/work/westgroup/ChrisB/_01_MeOH_repos/uncertainty_analysis/rmg_gua/cantera/all_experiments_reorg_sbr.yaml'
