###############################################
# Single crystal batch reactor
# Chris Blais
# Northeastern University
#
# based on model described by Charles T. Campbell in 
# Advances in Catalysis, vol 36, pp 1-15
...
class Min_Batch:
    """
    A minimal single crystal reactor, based on the design from Dr. Campbell
    """
    def __init__(
        self,
        yaml_file,
